...
$string['barwithrating'] = 'View reviews with {$a->rating}-star ratings ({$a->percent} of all ratings)';
...
$string['privacy:flags'] = 'Flagged reviews';
$string['privacy:metadata:core_files'] = 'Files embedded in the course reviews';
...
$string['reviewsarehidden'] = 'Students can see only the average rating but not the text reviews.';
...
$string['showallreviewsforrating'] = 'Showing reviews with {$a}-star ratings.';
