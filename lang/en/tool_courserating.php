...
$string['noreviewpermission'] = 'You don\'t have permission to view review data on this course';
...
$string['percourseoverrideconfig'] = 'If enabled, two custom course fields will be created that will allow to set when each individual course can be rated and reviewed. The value of the settings "When can courses be rated" and "When can courses be reviewed" will be treated as the default';
...
$string['reviewbyanybody'] = 'Students can review the course at any time';
$string['reviewbycompleted'] = 'Students can review only after completing the course';
$string['reviewbydefault'] = 'Default value is: "{$a}"';
$string['reviewbynoone'] = 'Course reviews are disabled';
$string['reviewmode'] = 'When can courses be reviewed';
$string['reviewmodeconfig'] = 'Additionally the capability to review courses is checked';
...
$string['summary_reviewmode'] = "Course review mode";
