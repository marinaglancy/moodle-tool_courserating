...
$string['showusernames'] = 'Show usernames';
$string['showusernamesconfig'] = 'Controls the visibility of usernames in course ratings.';
$string['hide'] = 'Hide';
$string['show'] = 'Show';
$string['percourse'] = 'Hide Usernames on a Per-Course Basis';
$string['showusernamespercourseconfig'] = 'Allows setting username visibility for course ratings on a per-course basis.';
$string['usernamevisibilitytoggle'] = 'Hide Usernames on a Per-Course Basis';